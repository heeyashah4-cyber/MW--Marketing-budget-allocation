...
document.querySelectorAll('.tabbtn').forEach(btn=>{
  btn.addEventListener('click', ()=>{
    ...
    const radio = document.getElementById('tab-'+btn.dataset.tab);
...
updateSummary();
  ...
  window.bootOptimizer = bootOptimizer;
  function start() {
