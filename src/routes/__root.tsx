...
const APP_NAME = "Marketing Budget Optimizer";
  ...
  head: () => ({
    meta: [
      ...
      { name: "theme-color", content: "#101418" },
      {
        name: "description",
        content:
          "Three-year channel performance and a ₹50L/month budget allocator across 10 marketing channels.",
      },
    ],
    links: [
